...
5. Use the focused ATLAS sync plan as the test next-action source. Complete one approved action, refresh the plan, and do not run a canonical suite while create/update actions or required judges remain.
