# Workflow Test Result: site-query-detail

**Status:** PASSED
**Workflow:** XDX_SUPPLIER_CORE_20260924 (DRAFT v86232573)
**Scenario:** custom user test
**Test Intent:** Verify ordinary parent-scoped site detail independently of create confirmation.
**Data Source:** file
**Evaluation:** hybrid
**Workflow Time:** 16526 ms (sum of node times)
**Test Run Time:** 18035 ms
**Test File:** `test/workflows/xdx_supplier_core_20260924/site-query-detail.json`
**JSON Report:** `C:\Users\dasu\Documents\GitHub\fusion-ai-studio-1\.worktrees\xdx-supplier-core-20260924\test-reports\workflows\xdx_supplier_core_20260924\site-query-detail\result.json`
**Markdown Report:** `C:\Users\dasu\Documents\GitHub\fusion-ai-studio-1\.worktrees\xdx-supplier-core-20260924\test-reports\workflows\xdx_supplier_core_20260924\site-query-detail\result.md`
**HTML Report:** `C:\Users\dasu\Documents\GitHub\fusion-ai-studio-1\.worktrees\xdx-supplier-core-20260924\test-reports\workflows\xdx_supplier_core_20260924\site-query-detail\result.html`

## Test Intent

**Type:** custom user test
**Intent:** Verify ordinary parent-scoped site detail independently of create confirmation.

## Invocation

**Message:** `Show site detail for SupplierSiteId 300000333814424 under Supplier ID 300000333814409.`
**Trigger Type:** app
**Single Turn:** no
...
| PASS | FETCH_SITE_DETAIL executes | Must execute | FETCH_SITE_DETAIL | Executed |
| PASS | SHAPE_SITE_DETAIL executes | Must execute | SHAPE_SITE_DETAIL | Executed |
| PASS | STORE_SITE_DETAIL executes | Must execute | STORE_SITE_DETAIL | Executed |
...
| PASS | Native read shape | One supported oraInfoDisplay widget has honest missing values and no write claim. Scalar detail has no invented paging. | Supported scalar-detail widget has honest missing inactive date, no invented paging and no write claim. |
...
Workflow time: 16526 ms (sum of node times)
Test run time: 18035 ms (includes CLI overhead)
...
| --- | --- | --- | --- |
| 8200 | 410 | 8610 | oci-agent/openai.gpt-5-mini |
...
| SITE_DISPLAY | 7287 | 182 | 7469 | oci-agent/openai.gpt-5-mini | computed:inputTokens+outputTokens, nodeProgressMessage.nodeStepInfo.details[0].inputTokens, nodeProgressMessage.nodeStepInfo.details[0].modelName, nodeProgressMessage.nodeStepInfo.details[0].outputTokens |
...
| SITE_DISPLAY | 7287 | 182 | 1 | 5 | premium | general |

| Node | Node Time (ms) | LLM Call Time (ms) | Details |
| --- | --- | --- | --- |
| EXTRACT_READ | 8251 | 8149 | 1 runtime detail; see JSON report |
| FETCH_SITE_PARENT | 46 |  | 0 runtime details; see JSON report |
| FETCH_SITE_DETAIL | 46 |  | 0 runtime details; see JSON report |
| SITE_DISPLAY | 8183 | 8100 | 1 runtime detail; see JSON report |

| Observed Field | Values |
| --- | --- |
| modelName | "oci-agent/openai.gpt-5-mini"; "oci-agent/openai.gpt-5-mini" |
| inputTokens | 913; 7287 |
| outputTokens | 228; 182 |
...
| FETCH_SITE_DETAIL | BO_FUNCTION | raw | no |  | 301 |

## Workflow Run

**Conversation ID:** workflow-test-site-query-detail-8d15a705-4e41-495e-8f76-e26a3f967a49
**Job ID:** a6b44903-6fef-4af7-921c-bde4c861ba06
**Finish Reason:** stop
**Raw Event Count:** 38
...
| FETCH_SITE_DETAIL | NODE_START, NODE_END | yes | yes |
| SHAPE_SITE_DETAIL | NODE_EXECUTED | yes | yes |
| STORE_SITE_DETAIL | NODE_EXECUTED | yes | yes |
