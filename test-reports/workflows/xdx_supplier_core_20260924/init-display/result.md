...
**Data Source:** file
**Evaluation:** hybrid
**Workflow Time:** 27707 ms (sum of node times)
**Test Run Time:** 29024 ms
**Test File:** `test/workflows/xdx_supplier_core_20260924/init-display.json`
**JSON Report:** `C:\Users\dasu\Documents\GitHub\fusion-ai-studio-1\.worktrees\xdx-supplier-core-20260924\test-reports\workflows\xdx_supplier_core_20260924\init-display\result.json`
**Markdown Report:** `C:\Users\dasu\Documents\GitHub\fusion-ai-studio-1\.worktrees\xdx-supplier-core-20260924\test-reports\workflows\xdx_supplier_core_20260924\init-display\result.md`
**HTML Report:** `C:\Users\dasu\Documents\GitHub\fusion-ai-studio-1\.worktrees\xdx-supplier-core-20260924\test-reports\workflows\xdx_supplier_core_20260924\init-display\result.html`
...
| PASS | INIT_DISPLAY executes | Must execute | INIT_DISPLAY | Executed |
...
| PASS | SUPPLIER_READ_DISPLAY does not execute | Must not execute | SUPPLIER_READ_DISPLAY | Not executed |


## Semantic Evaluation

**Judge Contract:** model-authored
**Terminal Output Owner:** `INIT_DISPLAY`
**Status:** passed
**Provider:** local
**Overall Score:** 5/5
**Minimum Score:** 4/5
...
Workflow time: 27707 ms (sum of node times)
Test run time: 29024 ms (includes CLI overhead)
...
| --- | --- | --- | --- |
| 8374 | 479 | 8853 | oci-agent/openai.gpt-5-mini |

| Node | Input Tokens | Output Tokens | Total Tokens | Model | Source |
| --- | --- | --- | --- | --- | --- |
| EXTRACT_READ | 959 | 216 | 1175 | oci-agent/openai.gpt-5-mini | computed:inputTokens+outputTokens, nodeProgressMessage.nodeStepInfo.details[0].inputTokens, nodeProgressMessage.nodeStepInfo.details[0].modelName, nodeProgressMessage.nodeStepInfo.details[0].outputTokens |
| INIT_DISPLAY | 7415 | 263 | 7678 | oci-agent/openai.gpt-5-mini | computed:inputTokens+outputTokens, nodeProgressMessage.nodeStepInfo.details[0].inputTokens, nodeProgressMessage.nodeStepInfo.details[0].modelName, nodeProgressMessage.nodeStepInfo.details[0].outputTokens |
...
| --- | --- | --- | --- | --- | --- | --- |
| EXTRACT_READ | 959 | 216 | 1 | 5 | premium | general |
| INIT_DISPLAY | 7415 | 263 | 1 | 5 | premium | general |

| Node | Node Time (ms) | LLM Call Time (ms) | Details |
| --- | --- | --- | --- |
| EXTRACT_READ | 16740 | 16638 | 1 runtime detail; see JSON report |
| FETCH_SUPPLIERS | 45 |  | 0 runtime details; see JSON report |
| INIT_DISPLAY | 10922 | 10846 | 1 runtime detail; see JSON report |

| Observed Field | Values |
| --- | --- |
| modelName | "oci-agent/openai.gpt-5-mini"; "oci-agent/openai.gpt-5-mini" |
| inputTokens | 959; 7415 |
| outputTokens | 216; 263 |
...
**Conversation ID:** workflow-test-init-display-f27117f1-3aba-4ab8-bc9f-9ec6847e0f91
**Job ID:** d5a958dd-20b2-4371-b884-6531e1aed1d4
**Finish Reason:** stop
**Raw Event Count:** 40
...
| INIT_DISPLAY | NODE_START, NODE_END | yes | yes |
