...
- The POST page and Example Request Body were retrieved and parsed with normal certificate validation. The authorized 2026-09-17 POST and read-back passed; see the [POST review](../../builds/xdx-supplier-information/xdx_supplier_post_review.md). SupplierType was omitted because CLI sample validation rejected both real source label and code as illustrative; the resulting SupplierType was null. This is a CLI limitation, not a Fusion rejection or proof of a default type.
