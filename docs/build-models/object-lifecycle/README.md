...
Current version: **1.0.0** — 2026-09-24.
...
1. Copy the [plan template](v1.0.0/plan-template.md) to a tracked build directory
...
3. Copy the [execution prompt](v1.0.0/execution-prompt.md) to that build directory,
...
See the [supplier worked example](v1.0.0/supplier-worked-example.md) for how to
