...
Model version: **1.0.0**. Status: historical illustration, not authorization.
...
| Previous local worktree/branch | Independent disposition | Actual path/ref, clean preserved state and integration proof before any removal |
