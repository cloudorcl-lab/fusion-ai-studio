...
Model version: **1.0.1**. Status: **UNFILLED / NOT AUTHORIZED FOR EXECUTION**.
...
- Worktree preservation choice: `<verified integration OR authorized exact-tip archive branch plus verified bundle and available prerequisites>`; authority and evidence: `<receipts>`.
...
| P3 | Approved worktree and refs | Clean preserved state, selected preservation disposition, path/registration/ref proof | No force; preserve and record blocker |
