...
1. Populate the [purge plan](v1.0.0/purge-plan-template.md) in a tracked
...
3. Populate the [execution prompt](v1.0.0/purge-prompt.md) and point it at that plan.
...
The [supplier example](v1.0.0/supplier-worked-example.md) demonstrates retention
