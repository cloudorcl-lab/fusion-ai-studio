...
SUP-READ and ADR-READ reopened after user404 reports for displayed supplier number1506. Native exact query/detail/address sequence passes on DRAFT86237214. Shared read-reference correction also covered for SITE-READ and CON-READ by actual-CODE tests. No accepted create repeated. Final repair receipt: xdx_manual_testing_results.md and evidence/xdx_number404_native.md; configured regression tracked separately from historical delivery suite.
