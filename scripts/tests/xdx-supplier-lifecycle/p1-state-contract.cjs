...
assert.match(byCode.PROJECT_RESPONSE_TEXT.metadata.sourceCode, /REDUCE_LIFECYCLE.*result\.prompt/);
assert.equal(byCode.SAVE_LIFECYCLE.outcomes.success, byCode.PROJECT_RESPONSE_TEXT.id);
